...
-จำกัดขนาดแต่ละรูปไม่เกิน 5 MB

if (file.size > 5 * 1024 * 1024) {
-เพิ่มให้เลือก/ส่งรูปได้หลายรูป
-RD Project /Raw Mat ให้เพิ่มไฟล์ได้


/*040726
test การส่ง memo ขอสินค้าตัวอย่าง ว่าแจ้งเตือน line ไหม (ผู้รับ ✓/ ผู้ส่ง ✓(เหมือนจะได้แล้ว ลอง test อีกรอบ)/ ผู้อนุมัติ ✓)
